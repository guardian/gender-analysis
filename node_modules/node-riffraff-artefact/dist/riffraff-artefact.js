...
function cloudformation() {
    return Q.all([util.createDir(SETTINGS.leadDir + "/" + SETTINGS.cloudformationAppTag), util.createDir(SETTINGS.leadDir + "/" + SETTINGS.cloudformationAppTag + "/cloudformation"), util.copyFile(SETTINGS.rootDir + "/" + SETTINGS.cloudformation, SETTINGS.leadDir + "/" + SETTINGS.cloudformationAppTag + "/cloudformation")]);
}
